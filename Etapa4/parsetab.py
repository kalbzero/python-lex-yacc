...
_lr_productions = [
  ...
  ('program -> sequence_declaration','program',1,'p_program','etapa4_yacc.py',19),
  ('sequence_declaration -> declaration sequence_declaration','sequence_declaration',2,'p_sequence_declaration','etapa4_yacc.py',23),
  ('sequence_declaration -> declaration','sequence_declaration',1,'p_sequence_declaration','etapa4_yacc.py',24),
  ('declaration -> type variavel define_end_of_instruction','declaration',3,'p_declaration','etapa4_yacc.py',28),
  ('declaration -> op_math','declaration',1,'p_declaration','etapa4_yacc.py',29),
  ('declaration -> statement_if','declaration',1,'p_declaration','etapa4_yacc.py',30),
  ('declaration -> statement_switch','declaration',1,'p_declaration','etapa4_yacc.py',31),
  ('declaration -> statement_for','declaration',1,'p_declaration','etapa4_yacc.py',32),
  ('declaration -> statement_while','declaration',1,'p_declaration','etapa4_yacc.py',33),
  ('statement_if -> IF LPAREN expression RPAREN LBRACE declaration RBRACE','statement_if',7,'p_statement_if','etapa4_yacc.py',37),
  ('statement_if -> IF LPAREN expression RPAREN LBRACE declaration RBRACE ELSE LBRACE declaration RBRACE','statement_if',11,'p_statement_if','etapa4_yacc.py',38),
  ('statement_switch -> SWITCH LPAREN ID RPAREN LBRACE define_cases define_default RBRACE','statement_switch',8,'p_statement_switch','etapa4_yacc.py',46),
  ('define_cases -> CASE value COLON LBRACE declaration define_break RBRACE','define_cases',7,'p_define_cases','etapa4_yacc.py',50),
  ('define_cases -> CASE value COLON LBRACE declaration define_break RBRACE define_cases','define_cases',8,'p_define_cases','etapa4_yacc.py',51),
  ('define_default -> DEFAULT COLON LBRACE declaration define_break RBRACE','define_default',6,'p_define_default','etapa4_yacc.py',55),
  ('statement_while -> WHILE LPAREN expression RPAREN LBRACE declaration RBRACE','statement_while',7,'p_statement_while','etapa4_yacc.py',59),
  ('statement_for -> FOR LPAREN condition_for SEMICOLON expression SEMICOLON alter_value RPAREN LBRACE declaration RBRACE','statement_for',11,'p_statement_for','etapa4_yacc.py',63),
  ('condition_for -> INT ID ASSIGN NUMBER define_end_of_instruction expression define_end_of_instruction alter_value define_end_of_instruction','condition_for',9,'p_condition_for','etapa4_yacc.py',67),
  ('alter_value -> ID PLUS PLUS','alter_value',3,'p_alter_value','etapa4_yacc.py',71),
  ('alter_value -> PLUS PLUS ID','alter_value',3,'p_alter_value','etapa4_yacc.py',72),
  ('alter_value -> ID MINUS MINUS','alter_value',3,'p_alter_value','etapa4_yacc.py',73),
  ('alter_value -> MINUS MINUS ID','alter_value',3,'p_alter_value','etapa4_yacc.py',74),
  ('op_math -> ID ASSIGN ID PLUS ID define_end_of_instruction op_math','op_math',7,'p_op_math','etapa4_yacc.py',77),
  ('op_math -> ID ASSIGN ID MINUS ID define_end_of_instruction op_math','op_math',7,'p_op_math','etapa4_yacc.py',78),
  ('op_math -> ID ASSIGN ID TIMES ID define_end_of_instruction op_math','op_math',7,'p_op_math','etapa4_yacc.py',79),
  ('op_math -> ID ASSIGN ID DIVIDE ID define_end_of_instruction op_math','op_math',7,'p_op_math','etapa4_yacc.py',80),
  ('op_math -> ID ASSIGN ID PLUS ID define_end_of_instruction','op_math',6,'p_op_math','etapa4_yacc.py',81),
  ('op_math -> ID ASSIGN ID MINUS ID define_end_of_instruction','op_math',6,'p_op_math','etapa4_yacc.py',82),
  ('op_math -> ID ASSIGN ID TIMES ID define_end_of_instruction','op_math',6,'p_op_math','etapa4_yacc.py',83),
  ('op_math -> ID ASSIGN ID DIVIDE ID define_end_of_instruction','op_math',6,'p_op_math','etapa4_yacc.py',84),
  ('expression -> condition MAIOR condition','expression',3,'p_expression','etapa4_yacc.py',92),
  ('expression -> condition MENOR condition','expression',3,'p_expression','etapa4_yacc.py',93),
  ('expression -> condition MAIOREQUALS condition','expression',3,'p_expression','etapa4_yacc.py',94),
  ('expression -> condition MENOREQUALS condition','expression',3,'p_expression','etapa4_yacc.py',95),
  ('expression -> condition EQUALS condition','expression',3,'p_expression','etapa4_yacc.py',96),
  ('expression -> condition DIFF condition','expression',3,'p_expression','etapa4_yacc.py',97),
  ('expression -> condition AND condition','expression',3,'p_expression','etapa4_yacc.py',98),
  ('expression -> condition OR condition','expression',3,'p_expression','etapa4_yacc.py',99),
  ('type -> INT','type',1,'p_define_type','etapa4_yacc.py',111),
  ('type -> FLOAT','type',1,'p_define_type','etapa4_yacc.py',112),
  ('type -> CHAR','type',1,'p_define_type','etapa4_yacc.py',113),
  ('value -> NUMBER','value',1,'p_define_value','etapa4_yacc.py',117),
  ('value -> DECIMAL','value',1,'p_define_value','etapa4_yacc.py',118),
  ('value -> STRING','value',1,'p_define_value','etapa4_yacc.py',119),
  ('condition -> ID','condition',1,'p_define_condition','etapa4_yacc.py',123),
  ('condition -> value','condition',1,'p_define_condition','etapa4_yacc.py',124),
  ('variavel -> ID','variavel',1,'p_variavel','etapa4_yacc.py',128),
  ('variavel -> ID COMMA variavel','variavel',3,'p_variavel','etapa4_yacc.py',129),
  ('variavel -> ID ASSIGN value','variavel',3,'p_variavel','etapa4_yacc.py',130),
  ('variavel -> ID ASSIGN value COMMA variavel','variavel',5,'p_variavel','etapa4_yacc.py',131),
  ('define_end_of_instruction -> SEMICOLON','define_end_of_instruction',1,'p_define_end_of_instruction','etapa4_yacc.py',135),
  ('define_break -> BREAK define_end_of_instruction','define_break',2,'p_define_break','etapa4_yacc.py',138),
]
